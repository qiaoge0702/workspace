...
| 模块 | 路径 | 状态 |
|------|------|------|
| **小程序前端** | `luolehaofang-new/mini-program/` | 待创建 |
| **后端服务** | `luole-haofang-new/server/` | 待创建 |

---

## 全局配置中枢 (Current Workspace Root)
所有全局宪法文件（`SOUL.md`, `TOOLS.md`, `USER.md` 等）均稳固存放于当前工作区根目录 `/Users/liuqiao/ai/workspace/`。